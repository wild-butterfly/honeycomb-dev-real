...
exports.deleteLabourEntry = exports.addLabourEntry = exports.getLabourEntries = void 0;
/* =========================================================
   GET LABOUR ENTRIES
========================================================= */
const getLabourEntries = async (req, res) => {
    const db = req.db;
    try {
...
exports.getLabourEntries = getLabourEntries;
/* =========================================================
   ADD LABOUR ENTRY
   GOD MODE SAFE FIX
========================================================= */
const addLabourEntry = async (req, res) => {
    const db = req.db;
    try {
        const jobId = Number(req.params.jobId);
        const { assignment_id, employee_id, start_time, end_time, worked_hours, uncharged_hours, chargeable_hours, rate, total, description, source = "manual", } = req.body;
        const { rows } = await db.query(`
...
exports.addLabourEntry = addLabourEntry;
/* =========================================================
   DELETE
========================================================= */
const deleteLabourEntry = async (req, res) => {
    const db = req.db;
    try {
...
exports.deleteLabourEntry = deleteLabourEntry;
