...
exports.deactivateEmployee = exports.getCompanyEmployees = exports.createEmployee = void 0;
...
const createEmployee = async (req, res) => {
    ...
    const { email, password, full_name, phone, job_title } = req.body;
    // Validation
    if (!email || !password) {
...
const deactivateEmployee = async (req, res) => {
    ...
    `);
        ...
        const employeeCheck = await db.query(`SELECT id, company_id, role FROM users WHERE id = $1`, [employeeId]);
        ...
        await db.query(`UPDATE users SET active = false WHERE id = $1`, [employeeId]);
