...
const AddTaskModal: React.FC<AddTaskProps> = ({
  employees = [],
  onClose,
  onSave,
}) => {
  ...
  const handleSave = () => {
    if (desc && assigned.length > 0 && due) {
      onSave({ description: desc, assigned, due });
      setDesc("");
      setAssigned([]);
      setDue("");
      onClose();
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalCard}>
        ...
        <div className={styles.modalBody}>
          ...
          />
          <label>
            Assign to employees <span className={styles.required}>*</span>
          </label>
        ...
        <div className={styles.modalActions}>
          <button className={styles.detailsBtn} onClick={onClose}>
            Cancel
          </button>
          <button
